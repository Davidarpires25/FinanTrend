...
const Hero:React.FC<Props> = (props: Props):JSX.Element => {
    return (
        <section id="hero">
            <div className=" min-h-screen container flex flex-col-reverse mx-auto p-8 lg:flex-row " >
                <div className="flex flex-col space-y-10 mb-44 m-10 lg:m-10 xl:m-20 lg:mt:16 lg:w-1/2 xl:mb-52">
                    ...
                    <p className="text-2xl text-center text-gray-400 lg:max-w-md lg:text-left dark:text-slate-300">
                    ...
                    <div className="mx-auto lg:mx-0">
                        <Link
                            to="/search"
                            className="py-5 px-10 text-2xl font-bold text-white bg-lightGreen rounded lg:py-4 hover:opacity-70 dark:text-slate-800"
                        >
                            Get Started
                        </Link>
                    </div>
